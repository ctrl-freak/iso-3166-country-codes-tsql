/**
  * Country names, continent names and ISO-3166 codes. Converted to TSQL dialect.
  *
  * @updated  2024-03-02
  * @link     http://www.geekality.net/?p=1182
  * @link     https://github.com/Svish/iso-3166-country-codes
  * @link     https://github.com/ctrl-freak/iso-3166-country-codes-tsql
  *
  */
CREATE SCHEMA [ISO3166]
GO

CREATE TABLE [ISO3166].[continents] (
  [code] CHAR(2) NOT NULL PRIMARY KEY, -- COMMENT 'Continent code'
  [name] VARCHAR(255),
)-- ENGINE=InnoDB;

INSERT INTO [ISO3166].[continents] VALUES
  ('AF', 'Africa'),
  ('AS', 'Asia'),
  ('EU', 'Europe'),
  ('NA', 'North America'),
...
CREATE TABLE [ISO3166].[countries] (
  [code] CHAR(2) NOT NULL PRIMARY KEY, -- COMMENT 'Two-letter country code (ISO 3166-1 alpha-2)',
  ...
  [continent_code] CHAR(2) NOT NULL CONSTRAINT fk_countries_continents FOREIGN KEY REFERENCES [ISO3166].[continents] ([code]),
--  KEY 'continent_code' [continent_code],
) -- ENGINE=InnoDB;

INSERT INTO [ISO3166].[countries] ([code], [continent_code], [name], [iso3], [number], [full_name]) VALUES
